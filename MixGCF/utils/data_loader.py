...
def load_data(model_args):
    ...
    if dataset == 'gowalla' or dataset == 'yelp2018' or dataset == 'ml-1m' or dataset == 'aminer':
    ...
    if args.dataset in['aminer', 'ml-1m']:
    ...
    print(user_dict['valid_user_set'])
    print(user_dict['test_user_set'])
    print('loading over ...')
